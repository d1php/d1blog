								...
								<tr>
									<td colspan="6">
										<div class="bulk-actions align-left">
											...
											<input type="button" class="button" value="应用" id="image_apply_button">
										</div>
								...
								<tr id="r<?php echo $value->id;?>">
									...
									<td>
										<!-- Icons -->
										 ...
										 <a href="javascript:delete_image('<?php echo $value->id;?>','<?php echo site_url().'admin/image/delete_img';?>','<?php echo $value->img_url;?>')" title="删除" id="del<?php echo $value->id;?>"><?php echo img(array("css/admin/images/icons/cross.png",'alt'=>"删除"));?></a> 
									</td>
