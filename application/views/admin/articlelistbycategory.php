								...
								<tr>
									<td colspan="6">
										<div class="bulk-actions align-left">
											...
											<input type="button" class="button" value="应用" id="article_category_apply_button">
										</div>
								...
								<tr id="r<?php echo $value->id;?>">
									...
									<td>
										<!-- Icons -->
										 ...
										 <a href="javascript:delete_article_bycategory('<?php echo $value->id;?>','<?php echo site_url().'admin/article/deletearticle_bycategory';?>')" title="删除" id="del<?php echo $value->id;?>"><?php echo img(array("css/admin/images/icons/cross.png",'alt'=>"删除"));?></a> 
									</td>
								</tr>
							<?php endforeach;?>
							<?php endif;?>	
